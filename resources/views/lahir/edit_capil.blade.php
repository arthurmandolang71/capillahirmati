                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="email" value="{{ old('email', $aktelahir->email) }}"
                                                    ...
                                                    id="validationCustomUsername" placeholder="Masukan email dari keluaraga"
                                                    disabled>
                                                @error('email')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="mb-6 col-md-6">
                                            <label class="text-label form-label" for="validationCustomUsername">Catatan
                                                Capil</label>
                                            <div class="input-group">
                                                <textarea name="catatan_capil" class="form-control @error('tentang') is-invalid @enderror"
                                                    placeholder="Catatan Capil">{{ old('tentang') }}</textarea>
                                                @error('catatan_capil')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
