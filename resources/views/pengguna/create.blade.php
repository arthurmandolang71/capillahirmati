    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="/referensi_struktur/struktur/">Struktur</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Referensi Struktur</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/pengguna/" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 col-md-9">
                                        ...
                                        <div class="input-group">
                                            <select name="kategori"
                                                class="form-control wide mb-3 @error('struktur_level') is-invalid @enderror">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="text-label form-label" for="validationCustomUsername">Apakah pengguna ini
                                        akan
                                        di aktifkan ?</label>
