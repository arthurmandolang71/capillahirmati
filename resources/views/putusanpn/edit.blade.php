                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/putusanpn/{{ $putusanpn->id }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="mb-6 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="nomor_perkara"
                                                value="{{ old('nomor_perkara', $putusanpn->nomor_perkara) }}" type="text"
                                    ...
                                    <div class="mb-6 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"> <i class="bi bi-card-heading"></i> </span>
                                            <input name="tanggal" value="{{ old('tanggal', $putusanpn->tanggal) }}"
                                ...
                                <hr>
                                <embed type="application/pdf" src="{{ asset('storage/' . $putusanpn->file) }}"
                                    width="400" height="400"></embed>
                                <div class="row">
